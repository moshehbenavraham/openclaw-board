...
export const FURNITURE_CATALOG: CatalogEntryWithCategory[] = [
	...
	{
		type: FurnitureType.PC_BACK,
		label: "PC Back",
		footprintW: 1,
		footprintH: 1,
		sprite: PC_BACK_SPRITE,
		isDesk: false,
		category: "electronics",
	},
	{
		type: FurnitureType.CAMERA,
		label: "Camera",
		footprintW: 1,
		footprintH: 1,
		sprite: [],
	...
	// ── Tileset — Desks ──
	{
		type: FurnitureType.TABLE_WOOD_SM_VERTICAL,
		label: "Wood Table Vertical",
		footprintW: 1,
		footprintH: 2,
		sprite: TS_TABLE_WOOD_SM_VERTICAL,
		isDesk: true,
		category: "desks",
	},
	{
		type: FurnitureType.TABLE_WOOD_SM_HORIZONTAL,
		label: "Wood Table Horizontal",
		footprintW: 2,
		footprintH: 1,
		sprite: TS_TABLE_WOOD_SM_HORIZONTAL,
		isDesk: true,
		category: "desks",
	},
	...
	// ── Tileset — Chairs ──
	{
		type: FurnitureType.CHAIR_CUSHION,
		label: "Cushioned Chair",
		footprintW: 4,
		footprintH: 1,
		sprite: TS_CHAIR_CUSHION,
		isDesk: false,
		category: "chairs",
	},
	{
		type: FurnitureType.CHAIR_SPINNING,
		label: "Spinning Chair",
		footprintW: 4,
		footprintH: 1,
		sprite: TS_CHAIR_SPINNING,
		isDesk: false,
		category: "chairs",
	},
	{
	...
	// ── Tileset — Decor ──
	{
		type: FurnitureType.WATER_COOLER,
		label: "Water Cooler",
		footprintW: 1,
		footprintH: 2,
		sprite: TS_WATER_COOLER,
		isDesk: false,
		category: "decor",
	},
	{
	...
	{
		type: FurnitureType.LIBRARY_GRAY_FULL,
		label: "Library Gray Full",
		footprintW: 2,
		footprintH: 2,
		sprite: TS_LIBRARY_GRAY_FULL,
		isDesk: false,
		category: "storage",
	},
	{
		type: FurnitureType.PLANT_SMALL,
		label: "Small Plant",
		footprintW: 1,
		footprintH: 1,
		sprite: TS_PLANT_SMALL,
		isDesk: false,
		category: "decor",
	},
	{
		type: FurnitureType.PAINTING_LARGE_1,
		label: "Painting Large 1",
		footprintW: 2,
		footprintH: 1,
		sprite: TS_PAINTING_LARGE_1,
		isDesk: false,
		category: "decor",
	},
	{
		type: FurnitureType.PAINTING_LARGE_2,
		label: "Painting Large 2",
		footprintW: 2,
		footprintH: 1,
		sprite: TS_PAINTING_LARGE_2,
		isDesk: false,
		category: "decor",
	},
	{
		type: FurnitureType.PAINTING_SMALL_1,
		label: "Painting Small 1",
		footprintW: 1,
		footprintH: 1,
		sprite: TS_PAINTING_SMALL_1,
		isDesk: false,
		category: "decor",
	},
	{
		type: FurnitureType.PAINTING_SMALL_2,
		label: "Painting Small 2",
		footprintW: 1,
		footprintH: 1,
		sprite: TS_PAINTING_SMALL_2,
		isDesk: false,
		category: "decor",
	},
	{
		type: FurnitureType.PAINTING_SMALL_3,
		label: "Painting Small 3",
		footprintW: 1,
		footprintH: 1,
		sprite: TS_PAINTING_SMALL_3,
		isDesk: false,
		category: "decor",
	},
];
...
export function getActiveCategories(): Array<{
	...
	const categories =
		dynamicCategories ||
		(FURNITURE_CATEGORIES.map((c) => c.id) as FurnitureCategory[]);
